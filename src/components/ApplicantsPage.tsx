...
export function ApplicantsPage() {
  ...
  const handleAccept = async (applicantId: string, projectId: string) => {
    try {
      await axios.patch(
        `${API_BASE}/api/applicant/projects/${projectId}/applicants/${applicantId}/accept`,
      );
      setApplicants((prev) =>
        prev.map((a) =>
  ...
  const handleReject = async (applicantId: string, projectId: string) => {
    try {
      await axios.put(
        `${API_BASE}/api/applicant/reject-applicants/${applicantId}`,
      );
      setApplicants((prev) =>
        prev.map((a) =>
            ...
            {filteredApplicants.length > 0 ? (
                      ...
                      {applicant.status === "pending" ? (
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleAccept(applicant.id, applicant.projectId);
                            }}
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleReject(applicant.id, applicant.projectId);
                            }}
              ...
              <div className="glass-panel rounded-xl p-12 text-center">
                ...
                <p className="text-gray-500 font-sans text-sm">
                  Applicants will appear here when they express interest in your
                  projects
                </p>
              </div>
            )}
        ...
        {selectedApplicant && (
          <div className="w-96 glass-panel rounded-xl p-6 h-fit sticky top-6">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <h3 className="text-xs text-gray-500 font-sans uppercase mb-2">
                  About
                </h3>
